    ...
    <div class="main-content">
        <div class="attendance-container">
            ...
            <div class="attendance-header">
                <h2><i class="fas fa-history"></i> Salary Calculation and Attendance Report</h2>
            </div>

            <!-- Form to calculate salary -->
            <form method="post" action="" class="salary-form">
                    ...
                    <select name="employeeID" required>
                        ...
                        <?php
                            foreach ($employees as $employee) {
                                echo "<option value='" . $employee['EmployeeID'] . "'>" . $employee['EmployeeLabel'] . "</option>";
                            }
                            ?>
                    </select>
                </div>
                ...
                <div class="form-group">
                    <label for="baseSalary">Base Salary (per day):</label>
                    <input type="number" step="0.01" name="baseSalary" placeholder="Enter Base Salary" required>
                </div>

                <div class="form-group">
                    <label for="bonus">Bonus:</label>
                    <input type="number" step="0.01" name="bonus" placeholder="Enter Bonus Amount" required>
                </div>

                <div class="form-group">
                    <label for="deductions">Deductions:</label>
                    <input type="number" step="0.01" name="deductions" placeholder="Enter Deductions" required>
                </div>
            ...
            <div class="attendance-table-wrapper">
                ...
                <div class="salary-summary">
                    <h3>Total Salary: <span class="highlight"><?= number_format($totalSalary, 2) ?></span></h3>
                    <p>Below are the details of the salary calculation:</p>
                </div>
                ...
                <table class="attendance-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>$<?= number_format($record['OvertimeHours'] * 50.00, 2) ?></td>
                            <td>$<?= number_format($baseSalary + ($record['OvertimeHours'] * 50.00) + $bonus - $deductions, 2) ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                ...
                <?php else : ?>
                <p class="no-data">Fill in the form above to calculate the salary and view attendance details.</p>
                <?php endif; ?>
            </div>
        </div>
    </div>
