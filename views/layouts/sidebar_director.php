...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-links">
            ...
            <li>
                <a href="Timekeeping-Rules.html"><i class="far fa-check-circle"></i>Timekeeping Rules</a>
            </li>
            <li>
            ...
            <li>
                <a href="index.php?action=list-attendance-rule">
                    <i class="fas fa-bug"></i>Setting Attendace Rule</a>
            </li>
            <li>
                <a href="notification-error.html"><i class="far fa-clock"></i>Receiving Violation notice</a>
            </li>
            <li>
                <a href="Viewreport.html"><i class="far fa-clock"></i>View Summary Report</a>
            </li>
            <!-- <li>
