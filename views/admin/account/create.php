            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <form method="POST" action="index.php?action=create-account">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="maritalStatus" name="maritalStatus">
                                        ...
                                        <option value="Có gia đình">Đã kết hôn</option>
                                    </select>
                                </div>
                                <div class="mb-3">
                                ...
                                <a href="/?controller=account&amp;action=index" class="btn btn-secondary">Hủy</a>
                            </form>
                        </div>
                    </div>
