            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <form method="POST"
                                action="index.php?action=edit-account&id=<?php echo $account['EmployeeID']; ?>">
                                <div class="mb-3">
                                ...
                                <div class=" mb-3">
                                    ...
                                    <input type="text" class="form-control" id="firstName" name="firstName"
                                        value="<?php echo htmlspecialchars($account['FirstName']); ?>">
                                </div>

                                <div class="mb-3">
                                    <label for="lastName" class="form-label">Tên</label>
                                    <input type="text" class="form-control" id="lastName" name="lastName"
                                        value="<?php echo htmlspecialchars($account['LastName']); ?>">
                                </div>

                                <div class="mb-3">
                                    <label for="dateOfBirth" class="form-label">Ngày sinh</label>
                                    <input type="date" class="form-control" id="dateOfBirth" name="dateOfBirth"
                                        value="<?php echo htmlspecialchars($account['DateOfBirth']); ?>">
                                </div>
                                ...
                                <div class="mb-3">
                                    <label for="identityNumber" class="form-label">Số CMND/CCCD</label>
                                    <input type="text" class="form-control" id="identityNumber" name="identityNumber"
                                        value="<?php echo htmlspecialchars($account['IdentityNumber']); ?>">
                                </div>

                                <div class="mb-3">
                                    <label for="identityIssuedDate" class="form-label">Ngày cấp CMND/CCCD</label>
                                    <input type="date" class="form-control" id="identityIssuedDate"
                                        name="identityIssuedDate"
                                        value="<?php echo htmlspecialchars($account['IdentityIssuedDate']); ?>">
                                </div>

                                <div class="mb-3">
                                    <label for="identityIssuedPlace" class="form-label">Nơi cấp CMND/CCCD</label>
                                    <input type="text" class="form-control" id="identityIssuedPlace"
                                        name="identityIssuedPlace"
                                        value="<?php echo htmlspecialchars($account['IdentityIssuedPlace']); ?>">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="phoneNumber" name="phoneNumber"
                                        value="<?php echo htmlspecialchars($account['PhoneNumber']); ?>">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="placeOfBirth" name="placeOfBirth"
                                        value="<?php echo htmlspecialchars($account['PlaceOfBirth']); ?>">
                                </div>

                                <div class="mb-3">
                                    <label for="nationality" class="form-label">Quốc tịch</label>
                                    <input type="text" class="form-control" id="nationality" name="nationality"
                                        value="<?php echo htmlspecialchars($account['Nationality']); ?>">
                                </div>
